        ...
        <>
            <div className="hidden lg:flex flex-col col-span-1 justify-between bg-[#f3f6f4] dark:bg-[#212121] py-10 h-full rounded-3xl border-2 border-[#f9f9f914]">
                <div className="flex items-center justify-center gap-x-3">
                    ...
                    <h1 className="text-base xl:text-2xl font-semibold w-min">{data?.email ? `${data.firstName}\n${data.lastName}` : 'ToDo\nApp'}</h1>
                </div>
                <NavLinkFragment />
                    ...
                    <SheetContent>
                        <div className="h-full flex flex-col justify-between">
                            <div className="flex items-center gap-x-4 mt-8">
                                <h1 className="text-end font-medium text-xl line-clamp-2">{data?.email ? `${data.firstName}\n${data.lastName}` : 'ToDo\nApp'}</h1>
